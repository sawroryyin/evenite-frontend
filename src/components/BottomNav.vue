...
const navItems = [
  ...
  { name: 'my-tickets', label: 'My Tickets', icon: 'M9 5H7a2 2 0 00-2 2v3a2 2 0 010 4v3a2 2 0 002 2h2m6-14h2a2 2 0 012 2v3a2 2 0 000 4v3a2 2 0 01-2 2h-2M9 5v14M9 9h.01M9 15h.01' },

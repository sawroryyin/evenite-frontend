...
<template>
  <div class="pt-4 pb-24 max-w-3xl mx-auto bg-[#fafafa] min-h-screen font-['Lato'] px-4">
    ...
    <div v-else-if="viewMode === 'SUMMARY' && summaryData" class="space-y-6 animate-fade-in">
      ...
      <div v-if="summaryData.totalResponses === 0" class="text-center py-10 bg-white rounded-2xl border border-gray-100 shadow-sm mt-2">
        <p class="text-gray-400 text-sm">No responses have been collected yet.</p>
      </div>
    ...
    <div v-else-if="viewMode === 'INDIVIDUAL' && individualData" class="animate-fade-in">
      ...
      <div v-if="individualData.totalResponses === 0" class="text-center py-10 bg-white rounded-2xl border border-gray-100 shadow-sm mt-6">
        <p class="text-gray-400 text-sm">No responses have been collected yet.</p>
      </div>

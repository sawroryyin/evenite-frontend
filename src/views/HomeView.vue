  ...
  <div class="pt-2 pb-24 max-w-screen-md mx-auto font-['Plus_Jakarta_Sans'] bg-[#fafafa] min-h-screen overflow-x-hidden relative">
    ...
    <div class="mb-4 mt-1 px-4 relative z-10">
      ...
      <p class="text-[11px] font-['Lato'] text-gray-400 font-medium mt-1.5 tracking-wide">
        What kind of event are you looking for today?
      </p>
    </div>

    <div class="relative w-full px-4 mb-3 z-10">
      <div class="absolute inset-y-0 left-0 pl-7 flex items-center pointer-events-none">
        <svg class="w-3.5 h-3.5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
      </div>
      <input type="text" placeholder="Search events..." class="w-full text-[12px] border-none rounded-xl py-2.5 pl-9 pr-4 focus:outline-none focus:ring-1.5 focus:ring-purple-400 bg-white shadow-sm font-['Lato']" />
    </div>

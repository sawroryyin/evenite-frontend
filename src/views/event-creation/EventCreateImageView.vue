...
<template>
  <div class="p-4 max-w-md mx-auto font-['Lato'] relative bg-transparent min-h-screen">
    ...
    <button
      @click="router.back()"
      class="mb-5 text-[#131B2B]/70 hover:text-[#131B2B] flex items-center gap-1.5 font-bold text-[11px] transition-colors 
    ...
    <div class="mb-5">
      <h1 class="text-[18px] font-black tracking-tight text-[#131B2B] mb-1">Generate from Image</h1>
      <p class="text-[11px] text-[#131B2B]/70 font-medium leading-snug">
    ...
    <template v-if="!previewUrl">
      <button
        ...
        :disabled="isLoading"
        class="px-4 py-8 border-2 border-[#131B2B]/20 border-dashed rounded-xl w-full text-[12px] font-bold flex flex-col 
        items-center gap-2.5 text-[#131B2B]/70 disabled:bg-[#131B2B]/5 disabled:text-[#131B2B]/40 disabled:border-[#131B2B]/10 
    ...
    <template v-else>
      ...
      <button 
        ...
        :disabled="isLoading"
        class="bg-[#131B2B] hover:bg-[#131B2B]/80 text-white px-4 py-2.5 rounded-xl 

...
<template>
  <div class="p-4 max-w-md mx-auto font-['Lato'] relative bg-transparent min-h-screen">
    ...
    <div class="mb-4">
      <h1 class="text-[18px] font-black tracking-tight text-[#131B2B]">Generate from Prompt</h1>
      <p class="text-[11px] text-[#131B2B]/70 font-medium mt-1">Describe your event and AI will draft the details.</p>
    </div>
    
    <textarea 
      v-model="promptText" 
      class="w-full border border-[#131B2B]/10 p-3 rounded-xl mb-3 focus:ring-1.5 focus:ring-[#131B2B]/30 
      focus:border-transparent focus:outline-none text-[12px] bg-[#131B2B]/5 placeholder-[#131B2B]/40 text-[#131B2B] shadow-inner" 
      rows="6"

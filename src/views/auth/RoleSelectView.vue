...
<template>  
  <div class="min-h-screen flex items-center justify-center bg-[#fafafa] font-['Lato'] px-4">
    <div class="max-w-xl w-full">
      <h1 class="text-2xl font-black text-gray-900 uppercase tracking-tight mb-2 text-center">Create Your Profile</h1>
      <p class="text-[12px] text-gray-500 text-center mb-8 font-bold">Select which profile you want to create first to start using Evenite. You can add the other profile later.</p>
      ...
      <div class="grid md:grid-cols-2 gap-4">
        <div @click="selectRole('PARTICIPANT')" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-purple-300 cursor-pointer transition-all hover:-translate-y-1">
          ...
          <h2 class="text-lg font-bold text-gray-900 mb-1">Create Participant Profile</h2>
        ...
        <div @click="selectRole('ORGANIZER')" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-indigo-300 cursor-pointer transition-all hover:-translate-y-1">
          ...
          <h2 class="text-lg font-bold text-gray-900 mb-1">Create Organizer Profile</h2>

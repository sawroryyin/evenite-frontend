...
<template>
  <div class="p-4 max-w-md mx-auto font-['Lato']">
    ...
    <div class="space-y-3">
      <div @click="router.push({ name: 'create-prompt' })" class="border border-gray-200 rounded-xl p-4 flex items-center gap-3 cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition shadow-sm">
        <div class="bg-blue-100 text-blue-600 p-2.5 rounded-lg flex-shrink-0">
      ...
      <div @click="router.push({ name: 'create-image' })" class="border border-gray-200 rounded-xl p-4 flex items-center gap-3 cursor-pointer hover:border-purple-400 hover:bg-purple-50 transition shadow-sm">
        <div class="bg-purple-100 text-purple-600 p-2.5 rounded-lg flex-shrink-0">
      ...
      <div @click="router.push({ name: 'create-manual' })" class="border border-gray-200 rounded-xl p-4 flex items-center gap-3 cursor-pointer hover:border-gray-400 hover:bg-gray-50 transition shadow-sm">
        <div class="bg-gray-100 text-gray-600 p-2.5 rounded-lg flex-shrink-0">
